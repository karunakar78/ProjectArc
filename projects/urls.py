...
urlpatterns = [
    ...
    path("allot-guide/", views.allot_guide_list, name="allot_guide_list"),
    # coordinator assigns guide to a specific project
    path("allot-guide/<int:pk>/", views.allot_guide, name="allot_guide"),
    # ── Evaluation ────────────────────────────────
    ...
    path("export/readme/", views.export_readme, name="export_readme"),
]
